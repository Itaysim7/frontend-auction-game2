...
export class Game extends Component
{
  constructor(props)
  {
    super(props)
    this.state = {
        isParticipant: true, currentIndex: 1, questionId: 1,  bonus:0, agent:0,  visible : false,
  ...
  render ()
  {
    const {isParticipant, x, y, w, zv, table, currentIndex, isButtonDisabled, bonus, agent, x_array} = this.state;
          ...
          <div className="training-header">
              ...
              <div>
                <h6 style={{color : 'white', backgroundColor: '#2d6ad5', border: '2px solid black',
                 paddingBottom:'5px', paddingTop:'5px',marginTop:'8px'}}> Rounds:{currentIndex} </h6>
                <h6 style={{color : 'white', backgroundColor: '#2d6ad5', border: '2px solid black',
                 paddingBottom:'5px', paddingTop:'5px',marginTop:'8px'}}> Your points:{(bonus*10).toFixed(2)}</h6>
                <h6 style={{color : 'white', backgroundColor: '#2d6ad5', border: '2px solid black',
